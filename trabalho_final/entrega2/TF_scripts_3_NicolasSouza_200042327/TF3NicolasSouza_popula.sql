...
INSERT INTO FUNCIONARIO VALUES 
	('2022-05-14', 1800, 'M', 95123866078), -- Amanda
    ('2022-06-15', 1850, 'M', 50375636072),	-- Bianca
    ('2022-07-07', 1850, 'M', 59386100010),	-- Rogério
    ('2021-01-25', 1800, 'G', 10613963040), -- Anderson Silva
    ('2022-08-30', 1850, 'G', 70406645000); -- Luana Piovani
...
INSERT INTO MEMBRO VALUES 
	(12018485040, 552602541254, '2022-04-25', 171, 'JOAO PEDRO DA SILVA',  1),
    (97770635047, 965835266541, '2022-04-25',1172, 'CIRO GOMES', 2),
    (78704526023, 523641256325, '2022-04-25', 173, 'PEDRO SAMPAIO', 3),
    (38312426078, 147258369123, '2022-04-25', 174,'MATHEUS FERNANDES', 4),
    (46918558072, 589625631452, '2022-04-25', 175, 'GIORGIAN ARRASCAETA', 5);
...
INSERT INTO ALUGUEL (dtAluguel, valor, contratoPath, idCliente) VALUES
	('2022-05-14', 50.0, '/data/contratos/2022/maio/12018485040.pdf', 12018485040),
    ('2022-06-15', 60.0, '/data/contratos/2022/junho/46918558072.pdf', 46918558072),
    ('2022-07-26', 70.0, '/data/contratos/2022/julho/38312426078.pdf', 38312426078),
    ('2022-06-15', 100.00, '/data/contratos/2022/junho/78704526023.pdf', 78704526023),
    ('2022-07-26', 120.00, '/data/contratos/2022/julho/12018485040.pdf', 12018485040);
