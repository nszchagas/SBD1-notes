...
-- BASE DE DADOS
create database if not exists TF_3D1_nicolassouza;
...
create table MEMBRO (
    ...
    dtUltimoPagamento	date			not null,
...
create table joga(
	apelidoJogador 	varchar(100) 	not null, 
    pontuacao		int 			not null, 
    idPartida		int				not null, 
    constraint joga_jogador_fk foreign key(apelidoJogador)
		references JOGADOR(apelido) on delete cascade,
	constraint joga_partida_fk foreign key(idPartida)
